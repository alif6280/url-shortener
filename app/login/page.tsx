...
export default async function LoginPage({
  ...
  const t = {
    title: isBn ? "স্বাগতম" : "Welcome Back",
    subtitle: isBn ? "আপনার অ্যাকাউন্টে প্রবেশ করুন" : "Sign in to your account",
    github: isBn ? "GitHub দিয়ে চালিয়ে যান" : "Continue with GitHub",
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black items-center justify-center p-12">
        <div className="text-white max-w-sm">
          ...
          <h2 className={`${playfair.className} text-4xl font-bold mb-4 leading-tight`}>
            Shorten URLs.<br />Track clicks.
          </h2>
          <p className="text-gray-400 text-sm leading-relaxed">
            Powerful URL shortener with deep analytics — completely free.
          </p>
          <div className="mt-8 flex gap-6">
            {[
              { value: "~30ms", label: "Redirect speed" },
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-sm">
          ...
          <form action={async () => {
            ...
            <button type="submit" className="w-full flex items-center justify-center gap-3 bg-black text-white rounded-xl py-3.5 text-sm font-medium hover:bg-gray-900 transition-colors">
          ...
          <p className="text-center text-sm text-gray-500">
            {t.noAccount}{" "}
            <Link href={`/register?lang=${lang}`} className="text-black font-medium hover:underline">
              {t.register}
            </Link>
          </p>
